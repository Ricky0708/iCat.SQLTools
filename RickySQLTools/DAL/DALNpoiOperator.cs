...
{
    internal class DALNpoiOperator
    {
        #region const and property
        ...
        internal bool WriteToExcel()
        {
            DataView dvTables = ds.Tables[dtTables].DefaultView;
            DataView dvColumns = ds.Tables[dtColumns].DefaultView;
            DataView dvFks = ds.Tables[dtFKs].DefaultView;
            DataView dvSpsAndFuncs = ds.Tables[dtSpsAndFuncs].DefaultView;
            DataView dvInputParams = ds.Tables[dtInputParams].DefaultView;
            DataView dvOutputParams = ds.Tables[dtOutputParams].DefaultView;
            DataView dvIndexes = ds.Tables[dtIndexes].DefaultView;
        ...
        private void DoWriteToExcel()
        {
            using (FileStream stream = new FileStream(System.Windows.Forms.Application.StartupPath + "\\SQLShema.xlsx", FileMode.Create, FileAccess.Write))
            {
                wb.Write(stream);
            }
        }
