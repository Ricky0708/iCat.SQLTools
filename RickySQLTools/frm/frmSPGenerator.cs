...
{
    public partial class frmSPGenerator : frmBase
    {

        DAL.DALSPGenerator objDAL = new DAL.DALSPGenerator();
        ShareUtility objUti = new ShareUtility();
        DataSet ds;
        CurrencyManager cmTables;

        public frmSPGenerator()
        {
            InitializeComponent();
            dgvTables.AutoGenerateColumns = false;
        }

        private void frmSPGenerator_Load(object sender, EventArgs e)
        {
        ...
        private void btn_Click(object sender, EventArgs e)
        {
            ...
            txtResult.Text = objDAL.GenerateScript(ds, tableName, sptype, txtAuthor.Text, txtDescription.Text);
