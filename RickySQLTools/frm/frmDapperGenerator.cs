...
{
    public partial class frmDapperGenerator : frmBase
    {
        DAL.DALDapperGenerator objDAL = new DAL.DALDapperGenerator();
        ShareUtility objUti = new ShareUtility();
        DataSet ds;
        CurrencyManager cmTables;

        public frmDapperGenerator()
        {
            InitializeComponent();
            dgvTables.AutoGenerateColumns = false;
        }

        private void frmDapperGenerator_Load(object sender, EventArgs e)
        {
        ...
        protected override void AfterSetConfig(object sender, object e)
        {
            ...
            {
                frmDapperGenerator_Load(null, null);
            }
            else
            {
